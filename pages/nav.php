...
?>
        ...
        <!-- <li class="nav-item">
          <a class="nav-link <?php echo ($file == 'register_1.php') ? 'active' : ''; ?>" href="../pages/register_1.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <!-- <li class="nav-item">
          <a class="nav-link  <?php echo ($file == 'register_2.php') ? 'active' : ''; ?>" href="../pages/register_2.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <!-- <li class="nav-item">
          <a class="nav-link <?php echo ($file == 'record_2.php') ? 'active' : ''; ?>" href="../pages/record_2.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <!-- <li class="nav-item">
        <a class="nav-link <?php echo ($file == 'visitor.php') ? 'active' : ''; ?>" href="../pages/visitor.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
...
?>
        ...
        <li class="nav-item">
          <?php
          $activeClass = in_array($file, ['useractivities.php']) ? 'active' : '';
          ?>
          <a class="nav-link <?php echo $activeClass; ?>" href="../pages/useractivities.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
