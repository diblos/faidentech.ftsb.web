  ...
  <!-- <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " data-color="warning">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main" style="height:100%;">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/register_1.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Authorize Registration</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="../pages/register_2.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Visitor Registration</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="../pages/record_2.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="nav-link-text ms-1">Today Record</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="">
            ...
            <span class="nav-link-text ms-1">Visitor Record</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="../pages/record.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <img src="../assets/css/img/faiden-logo.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">Faiden Tech Smart Barrier</span>
      </a>
      <li class="nav-item">
          <img src="../assets/css/img/QR-FTSB3.png" class="image2">
        </li>
      </ul>
    </div>
  </aside> -->
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Enter</p>
                    <h5 class="font-weight-bolder mb-0" id="enter">
                      Loading..
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
                  ...
                  <button type="submit" class="icon icon-shape bg-gradient-warning shadow text-center border-radius-md">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Exit</p>
                    <h5 class="font-weight-bolder mb-0" id="exit">
                      Loading..
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Authorize</p>
                    <h5 class="font-weight-bolder mb-0" id="authorize">
                      Loading..
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Visitor</p>
                    <h5 class="font-weight-bolder mb-0" id="visitor">
                      Loading..
                    </h5>
                  </div>
                </div>
                ...
                <!-- <div class="col-lg-6 col-5 my-auto text-end">
                  <div class="dropdown float-lg-end pe-4">
                    ...
                    <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable">
                      <li><a class="dropdown-item border-radius-md" href="javascript:All();">All</a></li>
                      <li><a class="dropdown-item border-radius-md" href="javascript:Entrance();">Entrance</a></li>
...
<?php
  if($ftype == 'user'){
    // POP UP: TIMOUT VEHICLES
    echo '<script src="../assets/js/visitor.js"></script>';
  }
?>
